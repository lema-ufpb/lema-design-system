# Spec: contribution-graph

> Gerado automaticamente para fechar gap spec-driven. Componente `components/ds/contribution-graph.tsx` estava sem spec em `docs/specs`. Base: template `docs/templates/component-spec.md`.

---

## Propósito

Componente `contribution-graph` — heatmap estilo GitHub 7×20.

**Usar quando:** compor páginas/layouts que precisam de contribution-graph.
...
| Campo      | Valor                                  |
| ---------- | -------------------------------------- |
| Arquivo    | `components/ds/contribution-graph.tsx` |
| Tipo       | `registry:ui`                          |
...
**Slots:** `contributionGraphVariants`
...
| i18n      | `UI_I18N[locale].contributiongraph`         |
