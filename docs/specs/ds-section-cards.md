...
> Gerado automaticamente para fechar gap spec-driven. Componente `components/ds/section-cards.tsx` estava sem spec em `docs/specs`. Base: template `docs/templates/component-spec.md`.

---

## Propósito

Componente `section-cards` — grid de 4 cards estatísticos com gradiente e badge trend.

**Usar quando:** compor páginas/layouts que precisam de section-cards.
...
| Campo      | Valor                             |
| ---------- | --------------------------------- |
| Arquivo    | `components/ds/section-cards.tsx` |
| Tipo       | `registry:block`                  |
| Categoria  | `Layout`                          |
