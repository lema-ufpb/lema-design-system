...
> Gerado automaticamente para fechar gap spec-driven. Componente `components/ds/comparison.tsx` estava sem spec em `docs/specs`. Base: template `docs/templates/component-spec.md`.

---

## Propósito

Componente `comparison` — slider antes/depois com controle por teclado.

**Usar quando:** compor páginas/layouts que precisam de comparison.
...
| Campo      | Valor                          |
| ---------- | ------------------------------ |
| Arquivo    | `components/ds/comparison.tsx` |
| Tipo       | `registry:ui`                  |
| Categoria  | `Layout`                       |
| Depende de | —                              |
