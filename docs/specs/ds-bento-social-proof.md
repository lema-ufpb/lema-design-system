# Spec: bento-social-proof

> Gerado automaticamente para fechar gap spec-driven. Componente `components/ds/bento-social-proof.tsx` estava sem spec em `docs/specs`. Base: template `docs/templates/component-spec.md`.

---

## Propósito

Componente `bento-social-proof` — grid bento de prova social com depoimentos e logos.

**Usar quando:** compor páginas/layouts que precisam de bento-social-proof.
...
| Campo      | Valor                                  |
| ---------- | -------------------------------------- |
| Arquivo    | `components/ds/bento-social-proof.tsx` |
| Tipo       | `registry:block`                       |
| Categoria  | `Layout`                               |
| Depende de | —                                      |
