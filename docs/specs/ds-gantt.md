...
> Gerado automaticamente para fechar gap spec-driven. Componente `components/ds/gantt.tsx` estava sem spec em `docs/specs`. Base: template `docs/templates/component-spec.md`.

---

## Propósito

Componente `gantt` — timeline Gantt com barras e progresso.

**Usar quando:** compor páginas/layouts que precisam de gantt.
...
| Campo      | Valor                     |
| ---------- | ------------------------- |
| Arquivo    | `components/ds/gantt.tsx` |
| Tipo       | `registry:ui`             |
| Categoria  | `Layout`                  |
| Depende de | skeleton                  |
