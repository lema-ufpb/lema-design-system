...
> Inspirado em https://www.launchuicomponents.com/docs/components/mockup — Launch UI Components. Evita colisão, criativo, acessível.

---

## Propósito

Mockup com frames small/large/mobile e notch — Launch UI Mockup. Evita colisão com browser-mockup (browser chrome) — aqui é device frame.

**Usar quando:** precisar de mockup com tokens DS.
...
| Campo      | Valor                      |
| ---------- | -------------------------- |
| Arquivo    | `components/ds/mockup.tsx` |
| Tipo       | `registry:ui`              |
| Categoria  | `Media`                    |
| Depende de | skeleton                   |
