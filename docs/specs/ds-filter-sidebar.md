...
> Gerado automaticamente para fechar gap spec-driven. Componente `components/ds/filter-sidebar.tsx` estava sem spec em `docs/specs`. Base: template `docs/templates/component-spec.md`.

---

## Propósito

Componente `filter-sidebar` — filtros de categoria e preço para e-commerce.

**Usar quando:** compor páginas/layouts que precisam de filter-sidebar.
...
| Campo      | Valor                                   |
| ---------- | --------------------------------------- |
| Arquivo    | `components/ds/filter-sidebar.tsx`      |
| Tipo       | `registry:ui`                           |
| Categoria  | `Navigation`                            |
| Depende de | card, checkbox, label, skeleton, slider |
