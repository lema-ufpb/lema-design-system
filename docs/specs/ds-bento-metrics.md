...
> Gerado automaticamente para fechar gap spec-driven. Componente `components/ds/bento-metrics.tsx` estava sem spec em `docs/specs`. Base: template `docs/templates/component-spec.md`.

---

## Propósito

Componente `bento-metrics` — grid bento métrico com gráfico e tira de estatísticas.

**Usar quando:** compor páginas/layouts que precisam de bento-metrics.
...
| Campo      | Valor                             |
| ---------- | --------------------------------- |
| Arquivo    | `components/ds/bento-metrics.tsx` |
| Tipo       | `registry:block`                  |
| Categoria  | `Layout`                          |
| Depende de | —                                 |
