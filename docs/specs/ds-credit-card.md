...
> Gerado automaticamente para fechar gap spec-driven. Componente `components/ds/credit-card.tsx` estava sem spec em `docs/specs`. Base: template `docs/templates/component-spec.md`.

---

## Propósito

Componente `credit-card` — cartão visual com gradiente e bandeira.

**Usar quando:** compor páginas/layouts que precisam de credit-card.
...
| Campo      | Valor                           |
| ---------- | ------------------------------- |
| Arquivo    | `components/ds/credit-card.tsx` |
| Tipo       | `registry:ui`                   |
...
| i18n      | `UI_I18N[locale].creditcard`                |
