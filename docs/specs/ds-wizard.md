...
> Gerado automaticamente para fechar gap spec-driven. Componente `components/ds/wizard.tsx` estava sem spec em `docs/specs`. Base: template `docs/templates/component-spec.md`.

---

## Propósito

Componente `wizard` — wizard multi-step com progresso.

**Usar quando:** compor páginas/layouts que precisam de wizard.
...
| Campo      | Valor                            |
| ---------- | -------------------------------- |
| Arquivo    | `components/ds/wizard.tsx`       |
| Tipo       | `registry:ui`                    |
| Categoria  | `Layout`                         |
