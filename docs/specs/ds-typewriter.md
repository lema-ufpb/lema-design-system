...
Texto com variantes typewriter/flip/generate, cursor piscante — Aceternity Text Generate + Typewriter + Flip Words. Respeita prefers-reduced-motion.
...
| Campo      | Valor                          |
| ---------- | ------------------------------ |
| Arquivo    | `components/ds/typewriter.tsx` |
| Tipo       | `registry:ui`                  |
| Categoria  | `Effects`                      |
| Depende de | —                              |
