...
> Gerado automaticamente para fechar gap spec-driven. Componente `components/ds/checkout.tsx` estava sem spec em `docs/specs`. Base: template `docs/templates/component-spec.md`.

---

## Propósito

Componente `checkout` — resumo de pedido com carrinho e pagamento.

**Usar quando:** compor páginas/layouts que precisam de checkout.
...
| Campo      | Valor                             |
| ---------- | --------------------------------- |
| Arquivo    | `components/ds/checkout.tsx`      |
| Tipo       | `registry:ui`                     |
| Categoria  | `Layout`                          |
| Depende de | button, card, separator, skeleton |
