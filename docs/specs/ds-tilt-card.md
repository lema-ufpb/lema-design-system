...
Card 3D com tilt e glare — Aceternity 3D Card + Wobble Card. Sem colisão com floating-card (tilt sutil) — aqui intensidade configurável e perspective 900px.
...
**Alternativa:** `card, skeleton` primitivos.
...
| Campo      | Valor                         |
| ---------- | ----------------------------- |
| Arquivo    | `components/ds/tilt-card.tsx` |
| Tipo       | `registry:ui`                 |
| Categoria  | `Effects`                     |
