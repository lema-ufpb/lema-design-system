...
> Gerado automaticamente para fechar gap spec-driven. Componente `components/ds/qr-code.tsx` estava sem spec em `docs/specs`. Base: template `docs/templates/component-spec.md`.

---

## Propósito

Componente `qr-code` — QR code com placeholder e ações.

**Usar quando:** compor páginas/layouts que precisam de qr-code.
...
| Campo      | Valor                       |
| ---------- | --------------------------- |
| Arquivo    | `components/ds/qr-code.tsx` |
| Tipo       | `registry:ui`               |
