...
> Gerado automaticamente para fechar gap spec-driven. Componente `components/ds/schedule.tsx` estava sem spec em `docs/specs`. Base: template `docs/templates/component-spec.md`.

---

## Propósito

Componente `schedule` — grade semanal com slots.

**Usar quando:** compor páginas/layouts que precisam de schedule.
...
| Campo      | Valor                        |
| ---------- | ---------------------------- |
| Arquivo    | `components/ds/schedule.tsx` |
| Tipo       | `registry:ui`                |
| Categoria  | `Layout`                     |
