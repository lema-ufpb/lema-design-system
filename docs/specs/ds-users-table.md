...
> Gerado automaticamente para fechar gap spec-driven. Componente `components/ds/users-table.tsx` estava sem spec em `docs/specs`. Base: template `docs/templates/component-spec.md`.

---

## Propósito

Componente `users-table` — tabela de usuários com avatar e status.

**Usar quando:** compor páginas/layouts que precisam de users-table.
...
| Campo      | Valor                           |
| ---------- | ------------------------------- |
| Arquivo    | `components/ds/users-table.tsx` |
| Tipo       | `registry:ui`                   |
| Categoria  | `Data Display`                  |
| Depende de | avatar, badge, card, skeleton   |
