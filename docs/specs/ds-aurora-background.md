...
Fundo aurora com bandas animadas, grid sutil e máscara radial — Aceternity Aurora + Sparkles + Wavy. 100% tokens.
...
| Campo      | Valor                                 |
| ---------- | ------------------------------------- |
| Arquivo    | `components/ds/aurora-background.tsx` |
| Tipo       | `registry:ui`                         |
| Categoria  | `Backgrounds`                         |
| Depende de | —                                     |
