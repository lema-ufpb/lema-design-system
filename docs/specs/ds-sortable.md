...
> Gerado automaticamente para fechar gap spec-driven. Componente `components/ds/sortable.tsx` estava sem spec em `docs/specs`. Base: template `docs/templates/component-spec.md`.

---

## Propósito

Componente `sortable` — lista arrastável vertical/grid.

**Usar quando:** compor páginas/layouts que precisam de sortable.
...
| Campo      | Valor                        |
| ---------- | ---------------------------- |
| Arquivo    | `components/ds/sortable.tsx` |
| Tipo       | `registry:ui`                |
| Categoria  | `Layout`                     |
| Depende de | —                            |
