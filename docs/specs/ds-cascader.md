...
> Gerado automaticamente para fechar gap spec-driven. Componente `components/ds/cascader.tsx` estava sem spec em `docs/specs`. Base: template `docs/templates/component-spec.md`.

---

## Propósito

Componente `cascader` — seletor em cascata multinível.

**Usar quando:** compor páginas/layouts que precisam de cascader.
...
| Campo      | Valor                        |
| ---------- | ---------------------------- |
| Arquivo    | `components/ds/cascader.tsx` |
| Tipo       | `registry:ui`                |
| Categoria  | `Form`                       |
| Depende de | button, popover, skeleton    |
