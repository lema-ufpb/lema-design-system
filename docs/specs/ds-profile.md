...
> Gerado automaticamente para fechar gap spec-driven. Componente `components/ds/profile.tsx` estava sem spec em `docs/specs`. Base: template `docs/templates/component-spec.md`.

---

## Propósito

Componente `profile` — card de perfil com avatar e badges.

**Usar quando:** compor páginas/layouts que precisam de profile.
...
| Campo      | Valor                                 |
| ---------- | ------------------------------------- |
| Arquivo    | `components/ds/profile.tsx`           |
| Tipo       | `registry:ui`                         |
| Categoria  | `Layout`                              |
| Depende de | avatar, badge, button, card, skeleton |
