...
> Gerado automaticamente para fechar gap spec-driven. Componente `components/ds/bento-features.tsx` estava sem spec em `docs/specs`. Base: template `docs/templates/component-spec.md`.

---

## Propósito

Componente `bento-features` — grid bento de features com ícones e métricas.

**Usar quando:** compor páginas/layouts que precisam de bento-features.
...
| Campo      | Valor                              |
| ---------- | ---------------------------------- |
| Arquivo    | `components/ds/bento-features.tsx` |
| Tipo       | `registry:block`                   |
| Categoria  | `Layout`                           |
| Depende de | —                                  |
