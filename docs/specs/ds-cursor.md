...
> Gerado automaticamente para fechar gap spec-driven. Componente `components/ds/cursor.tsx` estava sem spec em `docs/specs`. Base: template `docs/templates/component-spec.md`.

---

## Propósito

Componente `cursor` — cursor remoto com label para colaboração.

**Usar quando:** compor páginas/layouts que precisam de cursor.
...
| Campo      | Valor                      |
| ---------- | -------------------------- |
| Arquivo    | `components/ds/cursor.tsx` |
| Tipo       | `registry:ui`              |
