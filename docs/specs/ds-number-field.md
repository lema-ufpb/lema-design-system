...
> Gerado automaticamente para fechar gap spec-driven. Componente `components/ds/number-field.tsx` estava sem spec em `docs/specs`. Base: template `docs/templates/component-spec.md`.

---

## Propósito

Componente `number-field` — campo numérico com spinbuttons.

**Usar quando:** compor páginas/layouts que precisam de number-field.
...
| Campo      | Valor                            |
| ---------- | -------------------------------- |
| Arquivo    | `components/ds/number-field.tsx` |
| Tipo       | `registry:ui`                    |
| Categoria  | `Form`                           |
| Depende de | button, input                    |
