...
> Gerado automaticamente para fechar gap spec-driven. Componente `components/ds/sidebar-search.tsx` estava sem spec em `docs/specs`. Base: template `docs/templates/component-spec.md`.

---

## Propósito

Componente `sidebar-search` — campo de busca para sidebar com label sr-only.

**Usar quando:** compor páginas/layouts que precisam de sidebar-search.
...
| Campo      | Valor                              |
| ---------- | ---------------------------------- |
| Arquivo    | `components/ds/sidebar-search.tsx` |
| Tipo       | `registry:ui`                      |
| Categoria  | `Navigation`                       |
| Depende de | label, sidebar, skeleton           |
...
| i18n      | `UI_I18N[locale].sidebarsearch`             |
