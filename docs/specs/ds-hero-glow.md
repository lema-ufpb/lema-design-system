...
Hero com glow radial superior (radial-gradient blur 48px) + grid sutil mask — Launch UI Hero Top Glow. Evita colisão com hero-section (sem glow) e background-glow (background genérico).
...
| Campo      | Valor                         |
| ---------- | ----------------------------- |
| Arquivo    | `components/ds/hero-glow.tsx` |
| Tipo       | `registry:block`              |
| Categoria  | `Hero`                        |
