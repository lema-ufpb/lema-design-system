...
> Gerado automaticamente para fechar gap spec-driven. Componente `components/ds/image-zoom.tsx` estava sem spec em `docs/specs`. Base: template `docs/templates/component-spec.md`.

---

## Propósito

Componente `image-zoom` — zoom hover lens.

**Usar quando:** compor páginas/layouts que precisam de image-zoom.
...
| Campo      | Valor                          |
| ---------- | ------------------------------ |
| Arquivo    | `components/ds/image-zoom.tsx` |
| Tipo       | `registry:ui`                  |
