...
> Gerado automaticamente para fechar gap spec-driven. Componente `components/ds/team-switcher.tsx` estava sem spec em `docs/specs`. Base: template `docs/templates/component-spec.md`.

---

## Propósito

Componente `team-switcher` — seletor de equipe para sidebar com DropdownMenu.

**Usar quando:** compor páginas/layouts que precisam de team-switcher.
...
| Campo      | Valor                             |
| ---------- | --------------------------------- |
| Arquivo    | `components/ds/team-switcher.tsx` |
| Tipo       | `registry:ui`                     |
| Categoria  | `Navigation`                      |
| Depende de | sidebar, skeleton                 |
...
| i18n      | `UI_I18N[locale].teamswitcher`              |
