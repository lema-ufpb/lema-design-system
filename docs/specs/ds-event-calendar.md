...
> Gerado automaticamente para fechar gap spec-driven. Componente `components/ds/event-calendar.tsx` estava sem spec em `docs/specs`. Base: template `docs/templates/component-spec.md`.

---

## Propósito

Componente `event-calendar` — calendário mensal com eventos.

**Usar quando:** compor páginas/layouts que precisam de event-calendar.
...
| Campo      | Valor                              |
| ---------- | ---------------------------------- |
| Arquivo    | `components/ds/event-calendar.tsx` |
| Tipo       | `registry:ui`                      |
| Categoria  | `Layout`                           |
...
| i18n      | `UI_I18N[locale].eventcalendar`             |
