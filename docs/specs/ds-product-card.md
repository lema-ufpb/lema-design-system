...
> Gerado automaticamente para fechar gap spec-driven. Componente `components/ds/product-card.tsx` estava sem spec em `docs/specs`. Base: template `docs/templates/component-spec.md`.

---

## Propósito

Componente `product-card` — card de produto e-commerce.

**Usar quando:** compor páginas/layouts que precisam de product-card.
...
| Campo      | Valor                            |
| ---------- | -------------------------------- |
| Arquivo    | `components/ds/product-card.tsx` |
| Tipo       | `registry:ui`                    |
| Categoria  | `Data Display`                   |
| Depende de | badge, button, card, skeleton    |
