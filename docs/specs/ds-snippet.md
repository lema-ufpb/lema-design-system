...
> Gerado automaticamente para fechar gap spec-driven. Componente `components/ds/snippet.tsx` estava sem spec em `docs/specs`. Base: template `docs/templates/component-spec.md`.

---

## Propósito

Componente `snippet` — code snippet com tabs e copy.

**Usar quando:** compor páginas/layouts que precisam de snippet.
...
| Campo      | Valor                       |
| ---------- | --------------------------- |
| Arquivo    | `components/ds/snippet.tsx` |
| Tipo       | `registry:ui`               |
| Categoria  | `Form`                      |
| Depende de | button, tabs                |
