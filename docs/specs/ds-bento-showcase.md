...
> Gerado automaticamente para fechar gap spec-driven. Componente `components/ds/bento-showcase.tsx` estava sem spec em `docs/specs`. Base: template `docs/templates/component-spec.md`.

---

## Propósito

Componente `bento-showcase` — grid bento de showcase com browser mockup e copy.

**Usar quando:** compor páginas/layouts que precisam de bento-showcase.
...
| Campo      | Valor                              |
| ---------- | ---------------------------------- |
| Arquivo    | `components/ds/bento-showcase.tsx` |
| Tipo       | `registry:block`                   |
| Categoria  | `Layout`                           |
| Depende de | —                                  |
