...
> Gerado automaticamente para fechar gap spec-driven. Componente `components/ds/ticker.tsx` estava sem spec em `docs/specs`. Base: template `docs/templates/component-spec.md`.

---

## Propósito

Componente `ticker` — faixa financeira scroll infinito.

**Usar quando:** compor páginas/layouts que precisam de ticker.
...
| Campo      | Valor                      |
| ---------- | -------------------------- |
| Arquivo    | `components/ds/ticker.tsx` |
| Tipo       | `registry:ui`              |
| Categoria  | `Layout`                   |
| Depende de | —                          |
