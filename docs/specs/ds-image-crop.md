...
> Gerado automaticamente para fechar gap spec-driven. Componente `components/ds/image-crop.tsx` estava sem spec em `docs/specs`. Base: template `docs/templates/component-spec.md`.

---

## Propósito

Componente `image-crop` — crop com drag e zoom slider.

**Usar quando:** compor páginas/layouts que precisam de image-crop.
...
| Campo      | Valor                          |
| ---------- | ------------------------------ |
| Arquivo    | `components/ds/image-crop.tsx` |
| Tipo       | `registry:ui`                  |
| Categoria  | `Data Display`                 |
| Depende de | button, slider                 |
