...
> Gerado automaticamente para fechar gap spec-driven. Componente `components/ds/onboarding.tsx` estava sem spec em `docs/specs`. Base: template `docs/templates/component-spec.md`.

---

## Propósito

Componente `onboarding` — fluxo de onboarding com progresso.

**Usar quando:** compor páginas/layouts que precisam de onboarding.
...
| Campo      | Valor                            |
| ---------- | -------------------------------- |
| Arquivo    | `components/ds/onboarding.tsx`   |
| Tipo       | `registry:ui`                    |
| Categoria  | `Layout`                         |
| Depende de | button, card, progress, skeleton |
