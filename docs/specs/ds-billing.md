...
> Gerado automaticamente para fechar gap spec-driven. Componente `components/ds/billing.tsx` estava sem spec em `docs/specs`. Base: template `docs/templates/component-spec.md`.

---

## Propósito

Componente `billing` — cartão de plano, fatura e status de pagamento.

**Usar quando:** compor páginas/layouts que precisam de billing.
...
| Campo      | Valor                         |
| ---------- | ----------------------------- |
| Arquivo    | `components/ds/billing.tsx`   |
| Tipo       | `registry:ui`                 |
| Categoria  | `Layout`                      |
