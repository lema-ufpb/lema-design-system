...
## [1.7.1](https://github.com/lema-ufpb/design-system/compare/v1.10.1...v1.7.1) (2026-09-07)
...
* **card-stat:** add valueClassName prop for semantic color on value ([28be166](https://github.com/lema-ufpb/design-system/commit/28be166d5fecceb13026dbff1cda9f7f4621a87a))
...
* **card-stats:** add valueClassName prop, i18n integration, and page-loader component ([b35fb60](https://github.com/lema-ufpb/design-system/commit/b35fb602bcb154d5d9d23fa7df708ee5fcff57db))
...
* **dashbox:** add skeleton loading states for title, description, and toolbar ([5e381e4](https://github.com/lema-ufpb/design-system/commit/5e381e4fcc4a44a569b31db8148d5554dd76b279))
...
* **data-table:** add locale prop with i18n label resolution ([8a144b7](https://github.com/lema-ufpb/design-system/commit/8a144b76116453d189e648bbcb255974c7960b39))
...
* **data-table:** add onSelectedRowsChange callback and bulk-action story ([0ce0557](https://github.com/lema-ufpb/design-system/commit/0ce0557d927363692dc33b8ae423662b7e28c755))
...
* **data-table:** replace inline search with SearchBar, add voiceSearch and fluid column ([fa5495a](https://github.com/lema-ufpb/design-system/commit/fa5495ae267108eb6ff6799111ffb4b87d75ac72))
...
* **i18n:** add modal and dataTable translation keys across all locales ([98f4d74](https://github.com/lema-ufpb/design-system/commit/98f4d74cd7fa06200a3b08b4acd3f3766fbfa5fe))
* **i18n:** add pillGroup.filterLabel strings for all 4 locales ([00dce24](https://github.com/lema-ufpb/design-system/commit/00dce24631b01e24079426627481c13b3d457f8a))
* initial commit ([a814569](https://github.com/lema-ufpb/design-system/commit/a81456905465c3e39c89d3ca8141e837c2d5f712))
* **mini-card:** add MiniCard component, spec, and registry entry ([64c2d3a](https://github.com/lema-ufpb/design-system/commit/64c2d3aea2d77d9775e92574a3ad62585f1ba7f2))
* **modal:** add Modal component with size/intent variants ([6a0e6c4](https://github.com/lema-ufpb/design-system/commit/6a0e6c44e5ed336ac93823f9671c2cfa052fc107))
...
* **pill-group:** add reusable pill-shaped filter component ([458eda3](https://github.com/lema-ufpb/design-system/commit/458eda3948f8d39b583da8e3346d70aee25b223d))
...
* **ci:** commit next-env.d.ts for CSS type resolution in CI ([8cda6b4](https://github.com/lema-ufpb/design-system/commit/8cda6b413a3b6085024b990b92126ab7b334268c))
...
* **modal:** remove aria-describedby when no description is provided ([0f6fbd6](https://github.com/lema-ufpb/design-system/commit/0f6fbd6e1d608fb2e9e1fcf52dcd5e7de95e59be))
...
* **score-row:** correct role attributes for loading and list containers ([d64ae40](https://github.com/lema-ufpb/design-system/commit/d64ae4096316643eede3dbdf754d9dc13776e574))
...
* **toggle-theme:** prevent icon flash on page load by deferring render until mount ([a497352](https://github.com/lema-ufpb/design-system/commit/a4973522ececc737337d4d95b7b4e29f5df82bab))
...
* add Modal component and DataTable locale to registry and documentation ([4bc70d4](https://github.com/lema-ufpb/design-system/commit/4bc70d436a235f810679d4e958e11140ad1d7eaa))
...
* fix pt-BR locale code and update component counts ([002aace](https://github.com/lema-ufpb/design-system/commit/002aace972b2345f0e24e2e8a4af0d6e2d58924e))
...
* **readme:** add MiniCard to component library documentation ([93a4e27](https://github.com/lema-ufpb/design-system/commit/93a4e274ac636294e708f573def54d731217c62d))
...
* refresh Introduction and build tooling for 326 registry items ([526402d](https://github.com/lema-ufpb/design-system/commit/526402df2a0a1c1c40348cae82f91c39dab951fb))
...
* **specs:** add missing ds specs for animated-number, border-beam, form-builder and scroll-reveal ([78824e9](https://github.com/lema-ufpb/design-system/commit/78824e9fd095b7df16fda85fb169a4c185989363))
...
* **specs:** align component specs with current implementation ([8bf7fcb](https://github.com/lema-ufpb/design-system/commit/8bf7fcb983b8874fdac15d0ec6ed83a7fe1351fe))
...
* **specs:** sync component specs with current implementation ([9c88dad](https://github.com/lema-ufpb/design-system/commit/9c88dad414d226aa404afb62479a643645d7d741))
...
* **stories:** standardize Storybook docs to en-US Data API pattern ([e738ea0](https://github.com/lema-ufpb/design-system/commit/e738ea0675aea88b550d87ad7efe2aa1121b34ab))
...
* **mini-card:** move MiniCardCtx after Helpers to follow ordering convention ([a0a4fe0](https://github.com/lema-ufpb/design-system/commit/a0a4fe07b1a35505e8c69187d4b2d949280e3dce))
...
* simplify vitest config and remove baseUrl from tsconfig ([710c3c5](https://github.com/lema-ufpb/design-system/commit/710c3c540c90ffd5a69d436f9a777ebcaef11a58))
