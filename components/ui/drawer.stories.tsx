...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: [
          "Primitives from the shadcn/ui drawer, built on top of **vaul** by emilkowalski.",
          "",
          "Exposes the raw building blocks: `Drawer`, `DrawerTrigger`, `DrawerContent`,",
          "`DrawerHeader`, `DrawerTitle`, `DrawerDescription`, `DrawerFooter` and `DrawerClose`.",
          "For a higher-level API with optional header/footer and scrollable content,",
          "use the `Drawer` component from `drawer-ui`.",
          "",
          "## Structure",
          "",
          "```tsx",
          ...
          "| --- | --- | --- |",
          "| **Background** | `--popover` | Panel background color |",
          "| **Text** | `--popover-foreground` | Titles and body text |",
          "| **Sub-text** | `--muted-foreground` | Descriptions |",
          "| **Drag handle** | `--muted` | Pill indicator on bottom drawers |",
          "| **Overlay** | `bg-black/30` | Translucent background |",
