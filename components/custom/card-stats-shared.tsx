...
export const SIZE = {
  sm: {
    label: "text-xs font-semibold tracking-wide uppercase",
    ...
    highlightValue: "text-2xl font-semibold tracking-tight",
    highlightDesc: "text-xs",
    trackH: "h-1.5",
    gaugeMaxW: "max-w-[130px]",
    gaugeValue: "text-2xl font-semibold tracking-tight",
    listRowPy: "py-2",
    listText: "text-xs",
    listValue: "text-xs font-semibold tabular-nums",
    contentGap: "gap-2",
    compactValue: "text-lg font-semibold tracking-tight",
  },
  md: {
    label: "text-xs font-semibold tracking-wide uppercase",
    ...
    highlightValue: "text-3xl font-semibold tracking-tight",
    highlightDesc: "text-sm",
    trackH: "h-2",
    gaugeMaxW: "max-w-[160px]",
    gaugeValue: "text-3xl font-semibold tracking-tight",
    listRowPy: "py-2.5",
    listText: "text-sm",
    listValue: "text-sm font-semibold tabular-nums",
    contentGap: "gap-3",
    compactValue: "text-xl font-semibold tracking-tight",
  },
  lg: {
    ...
    highlightValue: "text-4xl font-semibold tracking-tight",
    highlightDesc: "text-base",
    trackH: "h-3",
    gaugeMaxW: "max-w-[200px]",
    gaugeValue: "text-4xl font-semibold tracking-tight",
    listRowPy: "py-3",
    listText: "text-base",
    listValue: "text-base font-semibold tabular-nums",
    contentGap: "gap-4",
    compactValue: "text-2xl font-semibold tracking-tight",
  },
...
export function TrendBadge({
  ...
  return (
    ...
    >
      <Icon className={cn(s.badgeIcon, "shrink-0")} aria-hidden />
      {value}
    </span>
  )
}
