...
import { RadialChart } from "@/components/ds/radial-chart"
    ...
    docs: {
      description: {
        component: [
          ...
          "### `data`",
          "",
          "An array of ring descriptor objects. Each object represents one concentric bar.",
          "",
          "```tsx",
          "const data = [",
          '  { name: "Attendance",   value: 94,  color: "var(--chart-1)" },',
          '  { name: "Completion",   value: 78 },',
          '  { name: "Satisfaction", value: 88,  color: "var(--chart-3)" },',
          "]",
          "```",
          "",
          "| Field | Type | Required | Description |",
          "| --- | --- | --- | --- |",
          "| `name` | `string` | ✓ | Bar name — appears in legend, tooltip, and center label |",
          "| `value` | `number` | ✓ | Numeric value — determines the arc length |",
          "| `color` | `string` | — | Any CSS color; defaults to the next `--chart-N` token |",
          "",
          "> **Type:** `RadialChartItem[]`",
          "",
          "### Putting it together",
          "",
          "```tsx",
          ...
          "| --- | --- | --- | --- |",
          "| `data` | `RadialChartItem[]` | — | (required) Ring data |",
          "| `title` | `string` | — | Optional title |",
          "| `subtitle` | `string` | — | Optional subtitle |",
          "| `footer` | `React.ReactNode` | — | Optional footer |",
          "| `height` | `number` | `320` | Chart height in px |",
          "| `showTrack` | `boolean` | `true` | Show faint full-arc track behind each bar |",
          "| `showLegend` | `boolean` | `false` | Show legend |",
          '| `legendPosition` | `LegendPosition` | `"bottom"` | Legend position |',
          "| `showTooltip` | `boolean` | `true` | Show tooltip on hover |",
          "| `innerLabel` | `string` | — | Text label at the centre of the chart |",
          "| `maxValue` | `number` | — | Clamp the angular domain |",
          "| `startAngle` | `number` | `90` | Start angle in degrees |",
          "| `endAngle` | `number` | `-270` | End angle in degrees |",
          "| `valueFormatter` | `(value: number) => string` | — | Format bar values |",
