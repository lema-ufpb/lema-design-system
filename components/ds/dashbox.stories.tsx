    ...
    docs: {
      description: {
        component: [
          ...
          "| `status` | `live` \\| `warning` \\| `error` \\| `idle` | — | Status badge in header |",
          "| `locale` | `en-US` \\| `pt-BR` \\| `es-ES` \\| `fr-FR` | `en-US` | Locale for toolbar tooltips and status labels |",
          "| `statusLabels` | `Partial<Record<DashboxStatus, string>>` | — | Override status label per instance |",
          "| `onRefresh` | `() => void` | — | Async callback triggered by refresh button |",
          "| `showMaximize` | `boolean` | `true` | Show fullscreen toggle button |",
          "| `showMinimize` | `boolean` | `true` | Show collapse toggle button |",
