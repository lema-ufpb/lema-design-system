    ...
    docs: {
      description: {
        component: [
          ...
          "| --- | --- | --- | --- |",
          "| `steps` | `StepItem[]` | — | (required) Array of step descriptors |",
          "| `currentStepId` | `string` | — | (required) Currently active step ID |",
          "| `onStepClick` | `(id: string) => void` | — | Callback when a step is clicked |",
          '| `orientation` | `"horizontal" \\| "vertical"` | `"horizontal"` | Layout direction |',
          '| `size` | `"sm" \\| "md" \\| "lg"` | `"md"` | Circle and text scale |',
