...
import { LineChart } from "@/components/ds/line-chart"
    ...
    docs: {
      description: {
        component: [
          ...
          "### `data`",
          "",
          "An array of objects where each object represents a point on the X axis. Every object key must be a `string` and every value must be `string | number`.",
          "",
          "```tsx",
          ...
          "### `categoryKey`",
          "",
          "The object key used for the **X axis**. Each unique value in this field becomes a point on the line.",
          "",
          "```tsx",
          'categoryKey="month"  // "Jan", "Feb", "Mar" → each gets a data point',
          'categoryKey="dept"   // "Engineering", "Medicine" → each gets a data point',
          "```",
          "",
          ...
          "### `dataKeys`",
          "",
          "Which object keys to render as lines. Accepts two shapes:",
          "",
          "**1. Plain strings:**",
          "```tsx",
          'dataKeys={["revenue"]}',
          ...
          "```",
          "",
          "**2. Objects `{ key, label?, color?, dashed? }`:**",
          "```tsx",
          "dataKeys=[",
          '  { key: "revenue",  label: "Revenue" },',
          '  { key: "forecast", label: "Forecast", color: "var(--chart-3)", dashed: true },',
          "]",
          "```",
          "",
          ...
          "| `dashed` | `boolean` | Renders the line with a dashed stroke pattern |",
          "",
          "### `referenceLines`",
          "",
          "Draw horizontal reference lines (thresholds, targets, averages):",
          "",
          "```tsx",
          "referenceLines={[",
          '  { value: 50000, label: "Target", color: "var(--primary)" },',
          '  { value: 30000, label: "Minimum", dashed: false },',
          "]}",
          "```",
          "",
          "> **Type:** `LineChartReferenceLine[]`  •  Field `value` is required, `label`, `color`, `dashed` are optional",
          "",
          "### Putting it together",
          "",
          "```tsx",
          ...
          "| `dataKeys` | `LineChartKey[] \\| string[]` | — | (required) Keys to render as lines |",
          "| `categoryKey` | `string` | — | (required) Object key for the X axis |",
          "| `title` | `string` | — | Optional title |",
          "| `subtitle` | `string` | — | Optional subtitle |",
          "| `footer` | `React.ReactNode` | — | Optional footer |",
          '| `variant` | `LineChartVariant` | `"line"` | Chart variant |',
          '| `curve` | `LineCurve` | `"smooth"` | Line interpolation style |',
          '| `dots` | `LineDotVisibility` | `"hover"` | When to show data-point dots |',
          ...
          "| `referenceLines` | `LineChartReferenceLine[]` | — | Horizontal threshold lines |",
          "| `valueFormatter` | `(value: number) => string` | — | Format value-axis ticks and tooltip |",
          "| `showBrush` | `boolean` | `false` | Range brush for scrolling and zooming |",
          ...
          "| `xAxisLabel` | `string` | — | Label centred on the X axis |",
          "| `yAxisLabel` | `string` | — | Label centred on the Y axis |",
        ].join("\n"),
      },
    },
  },
