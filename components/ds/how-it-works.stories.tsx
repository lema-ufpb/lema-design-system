...
const steps = [
  { title: "Create account", description: "Sign up in seconds with your email.", icon: <BoxIcon /> },
  { title: "Configure", description: "Set up your workspace and preferences.", icon: <SparklesIcon /> },
  { title: "Launch", description: "Deploy and share with your team.", icon: <LayersIcon /> },
]
...
export const Default: Story = { args: { steps, title: "How it works", description: "Three simple steps to get started." } }
