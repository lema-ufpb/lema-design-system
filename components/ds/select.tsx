...
export const triggerVariants = cva(
  "flex w-full items-center justify-between rounded-lg border border-transparent bg-input/50 px-3 text-left font-medium transition-[color,box-shadow,background-color] outline-none hover:bg-input/80 focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/30 disabled:cursor-not-allowed disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 data-placeholder:text-muted-foreground",
  {
    variants: {
      size: {
