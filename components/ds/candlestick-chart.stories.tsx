...
import { CandlestickChart } from "@/components/ds/candlestick-chart"
    ...
    docs: {
      description: {
        component: [
          ...
          "### `data`",
          "",
          "An array of OHLC data point objects. Each object represents one trading period (day, week, month).",
          "",
          "```tsx",
          "const data = [",
          "  {",
          '    date: "2025-01-02",',
          "    open: 150.25, high: 152.80, low: 149.10, close: 151.50,",
          "    volume: 28400",
          "  },",
          "  {",
          '    date: "2025-01-03",',
          "    open: 151.50, high: 153.20, low: 150.00, close: 148.75,",
          "    volume: 32100",
          "  },",
          "]",
          "```",
          ...
          "| --- | --- | --- | --- |",
          "| `date` | `string` | ✓ | Period label — appears on the X axis |",
          "| `open` | `number` | ✓ | Opening price |",
          "| `high` | `number` | ✓ | Highest price during the period |",
          "| `low` | `number` | ✓ | Lowest price during the period |",
          "| `close` | `number` | ✓ | Closing price |",
          "| `volume` | `number` | — | Trading volume — rendered when `showVolume` is enabled |",
          "",
          "> **Type:** `CandleDataPoint[]`",
          "",
          "### `movingAverages`",
          "",
          "Overlay SMA lines on the chart:",
          "",
          "```tsx",
          "movingAverages={[",
          ...
          "### `referenceLines`",
          "",
          "Mark support/resistance or price targets:",
          "",
          "```tsx",
          "referenceLines={[",
          '  { value: 155, label: "Resistance" },',
          '  { value: 145, label: "Support", color: "var(--destructive)" },',
          "]}",
          "```",
          "",
          "### Putting it together",
          ...
          "    {",
          '      date: "2025-01-02",',
          "      open: 150, high: 153, low: 149, close: 151,",
          "    },",
          "  ]",
          "",
          "  return (",
          ...
          "| --- | --- | --- | --- |",
          "| `data` | `CandleDataPoint[]` | — | (required) OHLC data points |",
          "| `title` | `string` | — | Optional title |",
          "| `subtitle` | `string` | — | Optional subtitle |",
          "| `footer` | `React.ReactNode` | — | Optional footer |",
          "| `height` | `number` | `360` | Chart height in px |",
          '| `positiveColor` | `string` | `"#22c55e"` | Color for bullish candles |',
          '| `negativeColor` | `string` | `"#ef4444"` | Color for bearish candles |',
          "| `movingAverages` | `MovingAverageConfig[]` | — | SMA lines to overlay |",
          "| `referenceLines` | `CandlestickReferenceLine[]` | — | Horizontal price reference lines |",
          "| `showVolume` | `boolean` | `false` | Render volume bars |",
          ...
          "| `valueFormatter` | `(value: number) => string` | — | Format price values |",
          "| `format` | `FormatPreset` | — | Format preset |",
          "| `decimals` | `number` | — | Decimal places |",
          "| `currency` | `string` | — | Currency symbol |",
          "| `abbreviate` | `boolean` | — | Abbreviate large numbers |",
          "| `dateFormatter` | `(date: string) => string` | — | Format date strings |",
