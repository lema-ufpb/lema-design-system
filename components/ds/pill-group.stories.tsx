    ...
    docs: {
      description: {
        component: [
          ...
          "### `items`",
          "",
          "An array of pill descriptor objects. Each object represents one filter pill.",
          "",
          "```tsx",
          "const items = [",
          '  { value: "all",   label: "All",      count: 120 },',
          '  { value: "open",   label: "Open",     count: 74,  icon: FileTextIcon },',
          '  { value: "critical", label: "Critical", count: 8,   intent: "destructive" },',
          '  { value: "high",   label: "High",     count: 22,  intent: "warning", disabled: true },',
          "]",
          "```",
          "",
          "#### `PillGroupItem`",
          ...
          "| --- | --- | --- | --- |",
          "| `value` | `string` | ✓ | Unique identifier — returned in `onChange` |",
          "| `label` | `string` | ✓ | Display text inside the pill |",
          "| `count` | `number` | — | Numeric suffix — shown as a dimmed number after the label |",
          "| `icon` | `React.ElementType` | — | Lucide icon component rendered before the label |",
          "| `disabled` | `boolean` | — | Prevents selection — pill appears dimmed and non-interactive |",
          '| `intent` | `"default" \\| "success" \\| "warning" \\| "destructive"` | — | Active-state color; defaults to `"default"` (inverted bg) |',
          "",
          "> **Type:** `PillGroupItem[]`  •  **Required**",
          "",
          "### `value` / `onChange`",
          "",
          "Controlled selection. Accepts a single string or array depending on `multiple`:",
          "",
          "```tsx",
          "// Single-select",
          "<PillGroup items={items} value={selected} onChange={setSelected} />",
          "",
          "// Multi-select",
          "<PillGroup items={items} multiple value={selected} onChange={setSelected} />",
          "```",
          "",
          "| Prop | Type | Description |",
          "| --- | --- | --- |",
          "| `value` | `string \\| string[] \\| null` | Currently selected value(s) |",
          "| `multiple` | `boolean` | Enable multi-select mode |",
          "| `showCount` | `boolean` | Show numeric counts — auto-enabled when any item has `count` |",
          "",
          "---",
          "",
          "## Features",
