    ...
    docs: {
      description: {
        component: [
          ...
          "| --- | --- | --- | --- |",
          "| `data` | `HeatmapCell[]` | — | (required) Cell data |",
          "| `title` | `string` | — | Optional title |",
          "| `subtitle` | `string` | — | Optional subtitle |",
          "| `footer` | `React.ReactNode` | — | Optional footer |",
          '| `palette` | `HeatmapPalette` | `"blue"` | Preset color palette |',
          "| `colorFrom` | `string` | — | Low-end color for custom palette |",
          "| `colorTo` | `string` | — | High-end color for custom palette |",
          "| `showValues` | `boolean` | `false` | Display numeric value inside each cell |",
          "| `showScale` | `boolean` | `true` | Show gradient legend bar |",
          "| `cellSize` | `number` | — | Fixed cell width in px |",
          "| `cellHeight` | `number` | — | Fixed cell height in px |",
          "| `gap` | `number` | `3` | Gap between cells in px |",
          "| `valueFormatter` | `(value: number) => string` | — | Format cell values |",
          "| `format` | `FormatPreset` | — | Format preset |",
          "| `decimals` | `number` | — | Decimal places |",
          "| `currency` | `string` | — | Currency symbol |",
          "| `abbreviate` | `boolean` | — | Abbreviate large numbers |",
          "| `min` | `number` | — | Override computed min |",
          "| `max` | `number` | — | Override computed max |",
