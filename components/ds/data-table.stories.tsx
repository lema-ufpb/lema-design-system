...
const meta = {
    ...
    docs: {
      description: {
        component: [
          ...
          '| `size` | `"compact" \\| "default"` | `"default"` | Size variant |',
          '| `textSize` | `"xs" \\| "sm" \\| "md" \\| "lg"` | — | Text size (inferred from size) |',
          ...
          "| `rowCount` | `number` | — | Total rows (manual pagination) |",
          "| `defaultPageSize` | `number` | `10` | Default page size |",
          "| `pageIndex` | `number` | — | Controlled page index |",
          '| `defaultGlobalFilter` | `string` | `""` | Initial search filter |',
          "| `pageSizeOptions` | `number[]` | — | Page size selector options |",
          "| `selectRows` | `boolean` | `false` | Enable row selection |",
          "| `stickyColumns` | `number` | `0` | Number of sticky columns |",
          ...
          "| `voiceSearch` | `boolean` | `false` | Enable voice input |",
          "| `onVoiceStart` | `() => void` | — | Voice start callback |",
          "| `onVoiceEnd` | `() => void` | — | Voice end callback |",
          "| `onVoiceError` | `(error) => void` | — | Voice error callback |",
          "| `onRowClick` | `(row) => void` | — | Row click handler |",
          "| `onSelectedRowsChange` | `(rows) => void` | — | Selection change callback |",
          "| `locale` | `UILocale` | — | i18n locale |",
          "| `labels` | `DataTableLabels` | — | Custom label overrides |",
          "| `hasMore` | `boolean` | `false` | Has more rows (infinite scroll) |",
          "| `onLoadMore` | `() => void` | — | Load more callback |",
          "| `ariaLabel` | `string` | — | Table aria-label |",
        ].join("\n"),
      },
    },
  },
  argTypes: {
    ...
    pageIndex: { table: { disable: true } },
    pageCount: { table: { disable: true } },
...
export const PaginationPtBR: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Paginated table with `locale="pt-BR"` — button labels and the row counter are resolved automatically from `UI_I18N["pt-BR"]` with no manual `labels` prop.',
      },
    },
  },
  args: {
...
const GRANTS: Grant[] = [
  {
    id: "PIBIC-001",
    project: "Neural Networks Applied to Medical Diagnosis",
    agency: "CNPq",
    totalBudget: 48000,
    disbursed: 31200,
    executionRate: 0.65,
  ...
  {
    id: "PIBIC-002",
    project: "Climate Modeling of the Northeastern Semi-arid Region",
    agency: "CAPES",
    totalBudget: 120000,
    disbursed: 118560,
    executionRate: 0.988,
  ...
  {
    id: "PIBEX-003",
    project: "Digital Literacy in Rural Communities",
    agency: "MEC",
    totalBudget: 35000,
    disbursed: 12250,
    executionRate: 0.35,
  ...
  {
    id: "PIBIC-004",
    project: "Bioinformatics and Genomic Sequencing",
    agency: "FAPESQ",
    totalBudget: 85000,
    disbursed: 76500,
    executionRate: 0.9,
  ...
  {
    id: "PIBEX-005",
    project: "Social Entrepreneurship in the Paraíba Agreste",
    agency: "SEBRAE",
    totalBudget: 22000,
    disbursed: 8580,
    executionRate: 0.39,
  ...
  {
    id: "PIBIC-006",
    project: "Artificial Intelligence for Inclusive Education",
    agency: "CNPq",
    totalBudget: 195000,
    disbursed: 175500,
    executionRate: 0.9,
  ...
  {
    id: "PIBEX-007",
    project: "Food Security in Vulnerable Areas",
    agency: "MDS",
    totalBudget: 67500,
    disbursed: 45562.5,
    executionRate: 0.675,
  ...
  {
    id: "PIBIC-008",
    project: "Renewable Energy in the Semi-arid Region",
    agency: "ANEEL",
    totalBudget: 310000,
    disbursed: 272800,
    executionRate: 0.88,
  ...
  {
    id: "PIBEX-009",
    project: "Art and Culture in the Periphery of João Pessoa",
    agency: "MinC",
    totalBudget: 18000,
    disbursed: 6300,
    executionRate: 0.35,
  ...
  {
    id: "PIBIC-010",
    project: "Pharmacology of Medicinal Plants from Caatinga",
    agency: "FAPESQ",
    totalBudget: 140000,
    disbursed: 112000,
    executionRate: 0.8,
