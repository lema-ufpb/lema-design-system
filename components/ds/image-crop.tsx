...
export function ImageCrop({
  ...
  const handleKeyDown = (e: React.KeyboardEvent) => {
    ...
    if (e.key === "+" || e.key === "=") {
      e.preventDefault()
      handleZoom([Math.min(3, resolvedZoom + 0.1)])
    }
    if (e.key === "-") {
      e.preventDefault()
      handleZoom([Math.max(1, resolvedZoom - 0.1)])
    }
  }
  ...
  return (
    ...
    >
      <div
        ...
        className="relative h-48 w-full overflow-hidden rounded-xl bg-muted focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none sm:h-64"
      ...
      >
        ...
        <img
          ...
          style={{
            transform: `translate(${pos.x}px, ${pos.y}px) scale(${resolvedZoom})`,
            left: "50%",
            top: "50%",
            marginLeft: "-50%",
            marginTop: "-50%",
      ...
      <div className="flex items-center gap-3">
        ...
        {onCrop && (
          <Button
            size="sm"
            onClick={() => onCrop({ ...pos, zoom: resolvedZoom })}
